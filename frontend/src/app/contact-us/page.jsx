  ...
  return (
    <>
      ...
      <section className="text-gray-800">
        ...
        {/* ===== MAIN SECTION ===== */}
        <div className="max-w-7xl mx-auto px-6 sm:py-20 py-12 grid gap-20 lg:grid-cols-2 items-stretch">
          {/* ===== LEFT – ALL CONTACT INFO (now styled as a card) ===== */}
          <div className="bg-white border border-gray-200 rounded-md p-6 shadow-lg flex flex-col">
            {/* Corporate Office */}
            ...
            <div className="space-y-4 mb-8 flex-1">
              <InfoBox
                icon={<MapPin size={20} />}
                title="Address"
                value="59 DSIDC SHED scheme 1, Okhla Industrial Area Phase II, New Delhi - 110020, INDIA"
              />
              <InfoBox
                icon={<Phone size={20} />}
                title="Mobile"
              ...
              <InfoBox
                icon={<Mail size={20} />}
                title="Email"
                value="sales@airpackcompressor.com"
              />
            </div>
            ...
            <div className="space-y-4">
              <InfoBox
                icon={<MapPin size={20} />}
                title="Address 1"
                value="Plot No. 101, Sector 68 IMT, Faridabad Haryana - 121004, INDIA"
              />
              <InfoBox
                icon={<MapPin size={20} />}
                title="Address 2"
                value="Plot No. 63, Sector 68 IMT, Faridabad Haryana - 121004, INDIA"
              />
              <InfoBox
                icon={<Phone size={20} />}
                title="Phone"
                value="+91 11 26389999, +91 11 26388888"
              />
              <InfoBox
                icon={<Mail size={20} />}
                title="Email"
                value="raj@airpackcompressor.com"
              />
            </div>
          </div>

          {/* ===== RIGHT – FORM (now also flex column to stretch) ===== */}
          <div className="bg-white border border-gray-200 rounded-md p-6 shadow-lg flex flex-col">
            <h3 className="text-2xl font-semibold text-gray-900 mb-8">
              Reach Out To Us
            </h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-6 flex-1 flex flex-col">
              ...
              <div className="flex-1">
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  placeholder="Write your message here..."
                  className="w-full border border-gray-300 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-gray-900 focus:border-gray-900 outline-none resize-none h-[120px]"
                  required
                />
              </div>
...
function InfoBox({ icon, title, value }) {
  return (
    <div className="flex gap-4 items-start border border-gray-200 rounded-xl p-4 hover:shadow-md transition bg-white">
      <div className="flex items-center justify-center w-10 h-10 rounded-full bg-gray-900 text-white flex-shrink-0">
        {icon}
      </div>
      <div>
        <h4 className="font-semibold text-gray-900">{title}</h4>
...
function Input({
  ...
  return (
    <div>
      <label htmlFor={name} className="block text-lg font-medium mb-7">
        {label} {required && <span className="text-red-500">*</span>}
      </label>
      <input
        id={name}
